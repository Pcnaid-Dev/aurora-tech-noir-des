...
const solutions = [
  ...
  },
  {
    ...
    features: ['Integrated payments', 'Inventory management', 'Customer analytics', 'Mobile optimized'],
    color: 'var(--aurora-violet)'
  }
]
          ...
          <div className="glass-panel rounded-2xl p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                ...
                >
                  <ActiveIcon size={40} weight="duotone" style={{ color: activeSolution.color }} />
                </div>
          ...
          {solutions.map((solution, index) => {
            ...
            return (
              <button
                ...
                style={{
                  ...(isActive && { '--tw-ring-color': solution.color } as React.CSSProperties),
                  boxShadow: isActive
